...
// let map = L.map('mapid').setView([30, 30], 2);
  ...
  let streets = L.tileLayer('https://api.mapbox.com/styles/v1/mapbox/streets-v11/tiles/{z}/{x}/{y}?access_token={accessToken}', {
   ...
   // We create the satellitestreet view tile layer that will be the default background of our map.
...
// let torontoData = "https://raw.githubusercontent.com/hira-ayub/Mapping_Earthquakes/main/torontoRoutes.json";

// Accessing the Toronto neighborhoods GeoJSON URL.
let torontoHoods = "https://raw.githubusercontent.com/hira-ayub/Mapping_Earthquakes/main/torontoNeighborhoods.json";
